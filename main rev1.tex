...
% % add abstract
\input{chapters_rev1/0_abstract}
...
% add main content
% introduction
\input{chapters_rev1/1_introduction/1_general}

% methods
\input{chapters_rev1/2_methods/1_general.tex}
\input{chapters_rev1/2_methods/2_recordings}
\input{chapters_rev1/2_methods/3_processing.tex}

% % results
\input{chapters_rev1/3_results/1_behavior}
\input{chapters_rev1/3_results/2_eeg}

% discussion
\input{chapters_rev1/4_discussion/1_intro}

% \ack
% This research was supported by a grant from the German Federal Ministry of Education and Research (01GQ1511) to KG

% supplementary material
% \input{chapters_rev1/supplementary_material/1_behavior_supplementary}
