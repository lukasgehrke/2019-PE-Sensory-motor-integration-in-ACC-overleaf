...
% results
\input{chapters/3_results/1_behavior}
\input{chapters/3_results/2_discrimination}
\input{chapters/3_results/3_clustering_grand_average}
\input{chapters/3_results/4_context}
...
\input{chapters/2_methods/2_recordings}
\input{chapters/2_methods/3_processing.tex}
